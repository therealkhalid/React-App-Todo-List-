  ...
  return (
    ...
    <div className="container-fluid" style={{marginBottom:'10rem'}}>
               ...
               <img src={'https://cdn.iconscout.com/icon/premium/png-256-thumb/todo-list-1941995-1642325.png'} className="fluid" width={60} alt="" />
                ...
                <button className="navbar-toggler btn btn-warning" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
